    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-label for="gender" value="Gender" />
                <select id="gender" wire:model="state.gender" name="gender" style="height:37px;padding: 2px 10px;width:125px;border-color:#b5b3b6;border-radius:5px;" required>
            ...
            <x-label for="address" value="Full Home Address *" />
                <x-input id="address" class="block mt-1 w-full" type="text" name="address" wire:model="state.address" required/>
            
            <!-- CONTACT NUMBER -->
            <br>
            <x-label for="contactnumber" value="Mobile Number *" />
                <x-input id="contactnumber" class="block mt-1 w-full" type="tel" placeholder="Ex: 09xxxxxxxxx" name="contactnumber" wire:model="state.contactnumber" required/>
