...
<div class="main-body-content">
	<div class="home-title-header-2">BUY NOW</div>
	<div class="content-box-1">			
		<div class="table-content-box-1">
			...
			<div class="box-cart-item"> <!-- Generate this whole div for every cart item found in customer's cart -->
				...
				<div class="cart-action-column"></div>
			</div>
	...
	<div class="content-box-4">
		...
		<div class="content-box-2">
			...
			<p class="txt-note">Whenever you change the quantities of your product, always click on <b>UPDATE CART</b> to save your changes.</p>
		...
		<div class="content-box-2">
			...
			<button class="btn-cart-full-width" onclick="window.location.href = '{{url('buynow-checkout/'.$cart->product->id)}}';">PROCEED TO CHECKOUT</button>
		</div>
	</div>
</div>
